...
import cn.xiaoluo.ws.ws_1901.utils.util.JSONException;
import cn.xiaoluo.ws.ws_1901.utils.util.JSONObject;
...
public class LoginController {
    ...
    public void verifyLogin(HttpServletRequest request,
                            HttpServletResponse response,String username,String password,String geetest_challenge,
        ...
        if (gtResult == 1) {
            ...
            try {
                TbUser user = userService.queryLogin(username, password);
